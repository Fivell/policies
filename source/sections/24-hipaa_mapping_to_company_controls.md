# 24. HIPAA Mappings to Versionista Controls

Below is a list of HIPAA Safeguards and Requirements and the Versionista
controls in place to meet those.

| **Administrative Controls** HIPAA Rule             | Versionista Control      |
| -------------------------------------------------- | ------------------------ |
...
| **Physical Safeguards** HIPAA Rule        | Versionista Control                                  |
| ----------------------------------------- | ---------------------------------------------------- |
...
| **Technical Safeguards** HIPAA Rule          | Versionista Control                       |
| -------------------------------------------- | ----------------------------------------- |
